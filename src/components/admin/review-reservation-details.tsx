...
const ReservationDetailsTab: React.FC<ReservationDetailsTabProps> = ({
  ...
  // Check if time status should be shown based on reservation status
  const shouldShowTimeStatus = (reservationStatus: string): boolean => {
    return !['Approved', 'Pending Admin Approval'].includes(reservationStatus);
  };
            ...
            return (
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  {/* Only show time status if reservation status isn't Ongoing or Pending Admin Approval */}
                  {shouldShowTimeStatus(reservation.Status) && (
                    <div>
                      {editMode && reservation.Status !== 'Ongoing' && reservation.Status !== 'Pending Admin Approval' ? (
                        <Select
