    ...
    <section id="machines" className="p-10 pt-20 pl-20 pr-20 pb-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mb-auto ">
          ...
          <div className="bg-white overflow-hidden shadow-lg rounded-2xl border border-[#5e86ca] hover:shadow-lg hover:shadow-blue-300/50 transform hover:scale-105 transition-all duration-300">
            ...
            <a href="https://www.facebook.com/fablabeasternvisayas" className="text-[#145da0] hover:underline mb-2">Learn More</a>
            </div>
{/*}
        ...
        <div className="container mx-auto px-6 md:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <a href="https://www.facebook.com/fablabeasternvisayas" className="inline-block bg-[#0e4579] text-white font-qanelas1 text-lg py-3 px-8 rounded-full hover:bg-[#1c62b5] transition duration-300">
                Learn More About Us
              </a>
            </div>
