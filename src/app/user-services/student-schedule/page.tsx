...
// Day interface to use in FormData
interface Day {
  date: Date;
...
export default function Schedule() {
  ...
  function EVCInformation({ formData, updateFormData, nextStep, prevStep }: EVCInformationProps) {
    ...
    const addMaterial = () => {
      ...
      updateFormData('NeededMaterials', [...materials, newMaterial]);
    };
...
function DateTimeSelection({ formData, setFormData, nextStep, isDateBlocked }: {
  formData: FormData;
  setFormData: React.Dispatch<React.SetStateAction<FormData>>;
  nextStep: () => void;
  isDateBlocked: (date: Date) => boolean;
